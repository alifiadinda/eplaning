    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?php echo site_url();?>index.php/C_Pengusul" class="nav-link">Home</a>
        </li>
      </ul>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?php echo site_url();?>/C_Pengusul" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              <a href="<?php echo site_url('C_Pengusul/Belanja')?>" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo site_url();?>/C_Pengusul/RKA" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo site_url();?>/C_Pengusul/getDetailUsulanUnit/<?php echo $this->session->nama_ruangan; ?>" class="nav-link" >
            ...
            <li class="nav-item">
              <a href="<?= site_url('C_Pengusul/detail_belanja');?>" class="nav-link" >
