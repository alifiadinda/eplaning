			...
			<div class="row">
				<div class="col-sm-4 col-md-4 col-lg-4">
					<form method="post" action="<?= site_url('c_detailbelanja/savekaru') ?>">
						...
						<?php if(isset($edit)) { ?>
						<a href="<?= site_url('C_kasubid/detail_belanja/') ?>" class="btn btn-success">Batal
						</a>
						<?php } ?>
							...
							<tr>
								...
								<td>
									<div class="btn-group" role="group" aria-label="Basic example">
										<a type="button" class="btn btn-warning" href="<?= site_url('C_kasubid/detail_belanja/'.$d->id_detail) ?>"><i class="fa fa-edit"></i></a>
										<a type="button" class="btn btn-danger" onclick="return deleteRow('<?= $d->id_detail; ?>')" href="<?= site_url('c_detailbelanja/deletekasubid/'.$d->id_detail) ?>"><i class="fa fa-trash"></i></a>
									</div>
								</td>
							</tr>
							<?php } ?>
