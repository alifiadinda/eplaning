	...
	<div>
			...
			<thead class="text-center">
				<tr>
					...
					<th rowspan="2" style="vertical-align: middle;">Formulir <br> <?php echo $Draft->status?></th>
				</tr>
				<tr>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					<th>Program</th>
					<td colspan="2"><?php echo $Draft->program?></td>
				</tr>
				<tr>
					<th>Kegiatan</th>
					<td colspan="2"><?php echo $Draft->kegiatan?></td>
				</tr>
				<tr>
					<th>Sub Kegiatan</th>
					<td colspan="2"><?php echo $Draft->subkegiatan?></td>
				</tr>
				<tr>
					<th>Indikator</th>
					<td colspan="2"><?php echo $Draft->indikator?></td>
				</tr>
				<tr>
					<th>Target</th>
					<td colspan="2"><?php echo $Draft->target?></td>
				</tr>
				<tr>
					<th>Alokasi Tahun 2021</th>
					<td colspan="2"><?php echo $Draft->alokasi_tahun2021?></td>
				</tr>
			</tbody>
		</table>
