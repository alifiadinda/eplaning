    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?php echo site_url();?>/C_Perencana" class="nav-link">Home</a>
        </li>
      </ul>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?php echo site_url();?>/C_Perencana" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo site_url();?>/C_Perencana/getDetailUsulanUnit/<?php echo $this->session->nama_ruangan; ?>" class="nav-link" >
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview"> 
                <li class="nav-item">
                  <a href="<?php echo site_url();?>/C_Perencana/getItemUsulan" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Item Usulan</p>
                  </a>
                </li>
