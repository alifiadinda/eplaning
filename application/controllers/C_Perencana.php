...
class C_Perencana extends CI_Controller {
   ...
   public function index()
    {
        ...
        $this->load->view('perencana/header');
        // $this->load->view('admin/sidebar');
        $this->load->view('perencana/v_home', $data);
    ...
    public function RKA()
    {
        ...
        $this->load->view('perencana/header');
        // $this->load->view('admin/sidebar');
        $this->load->view('perencana/v_rka',$data);
        $this->load->view('perencana/footer');
    }
    ...
    public function Draft()
    {
        ...
        $this->load->view('perencana/header');
        // $this->load->view('admin/sidebar');
        $this->load->view('perencana/v_draft',$data);
        $this->load->view('perencana/footer');
    }
    ...
    public function DPA()
    {
        ...
        $this->load->view('perencana/header');
        // $this->load->view('admin/sidebar');
        $this->load->view('perencana/v_dpa',$data);
        $this->load->view('perencana/footer');
    }
    ...
    public function detail_belanja($id='')
    {
        ...
        $this->load->view('perencana/header');
        $this->load->view('perencana/v_detail_belanja',$data);
        $this->load->view('perencana/footer');
    }
     ...
     public function Belanja()
    {
        ...
        {
            $this->load->view('perencana/header');
            $this->load->view('perencana/v_belanja',$data);
            $this->load->view('perencana/footer');
        } else {
     ...
     public function detail($id_dpa='', $id_detail='')
    {
        ...
        $this->load->view('perencana/header');
        $this->load->view('perencana/v_detail', $data);
        $this->load->view('perencana/footer');
    }
    ...
    public function save_rincian(){
        ...
        redirect(site_url('c_Perencana/detail/'.$id_dpa));
    }
     ...
     public function edit($id = NULL)
    {
        ...
        if ( empty($id) || !$data['belanja'] ) redirect('C_Perencana/Belanja');
        ...
        {
            $this->load->view('perencana/header');
            $this->load->view('perencana/edit_belanja',$data);
            $this->load->view('perencana/footer');
        } else {
...
/*=============================================================== USULAN ===============================================================*/
    ...
    public function getDetailUsulanUnit()
    {
        ...
        $data['getItemUsulan']      = $this->M_admin->getItemUsulanAdmin();
        $this->load->view('perencana/header');
        $this->load->view('perencana/v_usulan',$data);
        $this->load->view('perencana/footer');
    }
